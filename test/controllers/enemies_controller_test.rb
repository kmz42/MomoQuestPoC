...
class EnemiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create enemy" do
    assert_difference("Enemy.count") do
      post enemies_url, params: { enemy: { gold_on_defeat: @enemy.gold_on_defeat, hp: @enemy.hp, name: @enemy.name, power: @enemy.power, xp_on_defeat: @enemy.xp_on_defeat } }
    end
  ...
  test "should update enemy" do
    patch enemy_url(@enemy), params: { enemy: { gold_on_defeat: @enemy.gold_on_defeat, hp: @enemy.hp, name: @enemy.name, power: @enemy.power, xp_on_defeat: @enemy.xp_on_defeat } }
